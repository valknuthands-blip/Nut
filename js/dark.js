(function() {
    ...
    function initPortfolio() {
        ...
        // Wrap image-container and btn-container in .photography-cube-wrapper if not already done
        ...
        // Fix all links inside photography section images — prevent new tab
        document.querySelectorAll('.photography-section a, .photography-section .image-container span').forEach(el => {
            el.addEventListener('click', (e) => { e.preventDefault(); });
        });
        // Remove target="_blank" from any image anchors
    ...
    function initMobileFeatures() {
        ...
        // Remove any legacy hamburger toggles
